...
function userRequestHandler(req,userRes){
    ...
    */
    ...
    //Cojad: Simplified Console log
    //logUtil.printLog(color.green("\nreceived request to : " + host + path));
    logUtil.printLog(color.green(protocol + "://" + host + path));
    ...
    function routeReq(callback){
        // Cojad: surpress messages for forwarded request.
...
function connectReqHandler(req, socket, head){
    ...
    //Cojad: surpress too much message here.
    logUtil.printLog(color.yellow("[https connect] " + host));
